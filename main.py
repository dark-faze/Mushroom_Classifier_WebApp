...
def main():
    ...
    if classifier == 'Support Vector Machine (SVM)':
        ...
        metrics = st.sidebar.multiselect("Which metrics you want ?", ('Confusion Matrix' , 'ROC Curve' , 'Precision-Recall Curve'))
    ...
    if classifier == 'Random Forest':
        ...
        bootstrap = st.sidebar.radio("Bootstrap samples when making trees",('True','False'), key = 'bootstrap')
